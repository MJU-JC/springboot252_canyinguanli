...
//                            yonghuEntity.setYonghuSumJifen(data.get(0));                    //总积分 要改的
//                            yonghuEntity.setYonghuNewJifen(data.get(0));                    //现积分 要改的
//                            yonghuEntity.setHuiyuandengjiTypes(Integer.valueOf(data.get(0)));   //会员等级 要改的
