            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.yuangongId">
                            员工
                        </span>
...
|| (sessionTable == 'yuangong' && scope.row.yuangongId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/canyinguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.yuangongId = el.yuangongId;//---
                            forum.yuangongName = el.yuangongName;
                            forum.yuangongPhone = el.yuangongPhone;
                            forum.yuangongIdNumber = el.yuangongIdNumber;
                            forum.yuangongPhoto = el.yuangongPhoto;
                            forum.yuangongEmail = el.yuangongEmail;
                            forum.createTime = el.createTime;
